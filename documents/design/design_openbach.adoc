...
[#img-influxdb_data_access,reftext='Figure {counter:refnum}']
.Class Diagram of data access for InfluxDB 
image::influxdb_data_access.png[align="center"]
{nbsp} +

[#img-elastic_data_access,reftext='Figure {counter:refnum}']
.Class Diagram of data access for ElasticSearch
image::influxdb_data_access.png[align="center"]
{nbsp} +
