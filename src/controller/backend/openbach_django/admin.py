...
admin.site.register(JobKeyword)
...
admin.site.register(RequiredJobArgument_Instance)
admin.site.register(OptionalJobArgument_Instance)
admin.site.register(JobArgumentValue)
admin.site.register(Watch)
admin.site.register(OpenbachFunction)
admin.site.register(OpenbachFunctionArgument)
admin.site.register(Scenario)
admin.site.register(ScenarioArgument)
admin.site.register(ScenarioInstance, AdminInstances)
admin.site.register(ScenarioArgumentInstance)
...
admin.site.register(ConditionBelowOrEqual)
admin.site.register(ConditionBelow)
admin.site.register(ConditionUpperOrEqual)
admin.site.register(ConditionUpper)
admin.site.register(OpenbachFunctionInstance)
admin.site.register(WaitForLaunched)
admin.site.register(WaitForFinished)
admin.site.register(OpenbachFunctionArgumentInstance)
