...
| list_scenario_instances       | GET           | /scenario_instance                           | scenario_names                        | List all the scenario instances of one or more specific scenarios or all scenarios (and their scenario instances) if no scenario id is given
...
| modify_project                | PUT           | /project/*name*                    | *project_json*                        | Modify an existant Project
| del_project                   | DELETE        | /project/*name*                    |                                       | Delete a Project
| get_project                   | GET           | /project/*name*                    |                                       | Get a specific Project
