...
ansible-playbook -i configs/hosts -e @configs/ips -e @configs/all -e ansible_ssh_user=$controller_username -e ansible_sudo_pass=$controller_password -e ansible_ssh_pass=$controller_password install/controller.yml --tags install
ansible-playbook -i configs/hosts -e @configs/ips -e @configs/all -e ansible_ssh_user=$collector_username -e ansible_sudo_pass=$collector_password -e ansible_ssh_pass=$collector_password install/collector.yml --tags install
