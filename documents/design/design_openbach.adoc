...
| status_add_collector          | GET         | /collector/status           | *address*                                                            | Return the status of the installation of the new Collector
| modify_collector              | PUT         | /collector/*address*        | logs_port, stats_port                                                | Modify the Collector (and all the associated Agents)
| status_modify_collector       | GET         | /collector/*address*/status | *action='modify'*                                                    | Return the status of the modification of the Collector
| del_collector                 | DELETE      | /collector/*address*        |                                                                      | Remove a Collector (but do not uninstall the Agent on it)
| status_del_collector          | GET         | /collector/*address*/status | *action='del'*                                                       | Return the status of the deletion of the Collector
...
|===
| Function                      | Method      | url                     | Input contents (JSON or Query sting)                                          | Description
| install_agent                 | POST        | /agent                  | *address*, *username*, *password*, *collector_ip*, *name*, *action='install'* | Install OpenBACH Agent in a network entity (identified by IP address) and add the Agent information to the Controller database.
| status_install_agent          | GET         | /agent/status           | *address*, *action='install'*                                                 | Return the status of the installation of the Agent.
...
| status_uninstall_agent        | GET         | /agent/*address*/status | *action='uninstall'*                                                          | Return the status of the uninstallation of the Agent.
...
| status_retrieve_status_agents | GET         | /agent/status           | *address*, *action='retrieve_status'*                                         | Return the status of the retrievement of the status of the Agent
| assign_collector              | POST        | /agent/*address*        | *collector_ip*                                                                | Assign this Collector to the Agent
| status_assign_collector       | GET         | /agent/*address*/status | *action='assign'*                                                             | Return the status of the assignement of this Collector to the Agent
|===
...
| status_install_jobs         | GET           | /job/status            | *address*, *name*, *action=’status_install’*                                        | Return the status of the installation of a Job on an Agent
...
| status_uninstall_jobs       | GET           | /job/status            | *address*, *name*, *action=’status_uninstall’*                                      | Return the status of the uninstallation of a Job on an Agent
...
| status_retrieve_status_jobs | GET           | /job/status            | *address*, *action=’status_retrieve_status'*                                        | Return the status of the retrievement of the list of installed Jobs
...
| status_set_job_log_severity | GET           | /job/*job_name*/status | *address*, *action='log_severity'*                                                  | Return the status of the setting of a now log severity
...
| status_set_job_stat_policy  | GET           | /job/*job_name*/status | *address*, *action='stat_policy'*                                                   | Return the status of the setting of a now stats policy
| push_file                   | POST          | /file                  | *file*, *path*, *agent_ip*                                                          | Push a file on the Agent.
| status_push_file            | GET           | /file/status           | *filename*, *path*, *agent_ip*                                                      | Return the status of the push of a file on the Agent.
|===
...
| status_start_job_instance   | GET           | /job_instance/status      | *job_instance_id*, *action='start'*                                       | Return the status of the starting of a Job Instance
| stop_job_instance           | POST          | /job_instance             | *ids*, *action=’stop’*, date                                              | Stop one or more job instances using their instance id.
| status_stop_job_instance    | GET           | /job_instance/status      | *job_instance_id*, *action=’stop’*                                        | Return the status of the stopping of one or more job instance
...
| status_restart_job_instance | GET           | /job_instance/*id*/status | *action=’restart’*                                                        | Return the status of the restarting of a Job Instance
...
| status_watch_job_instance   | GET           | /job_instance/*id*/status | *action='watch'*                                                          | Return the status of the starting of a watch
...
And finally, the group 7 of openbach-functions allowing to start/stop a scenario instance and request for a list of scenario instance status.
