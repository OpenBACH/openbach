...
urlpatterns = [
    ...
    url(r'^instances/start$', views.start_job, name='start_job'),
    url(r'^instances/stop$', views.stop_job, name='stop_job'),
    url(r'^instances/restart$', views.restart_job, name='restart_job'),
    url(r'^instances/status$', views.status_job, name='status_job'),
