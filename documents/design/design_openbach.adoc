...
| list_scenario_instance        | GET           | /scenario_instance                           | scenario_ids                          | List all the scenario instances of one or more specific scenarios or all scenarios (and their scenario instances) if no scenario id is given
